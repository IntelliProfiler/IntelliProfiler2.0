...
# Description : Calculate dark/light activity ratio (%) from travel distance (TD) data across Zeitgeber Time (ZT) and perform group comparison using linear mixed models
